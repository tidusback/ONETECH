...
// Base table components — styled for dense financial data display.
// No vertical borders. Horizontal borders only. Monospace numbers.
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'h-11 px-4 align-middle text-sm text-foreground',
      '[&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
...
// Numeric cell — right-aligned, monospace, tabular figures
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'h-11 px-4 align-middle text-right font-mono text-sm tabular-nums',
      className
    )}
    {...props}
  />
